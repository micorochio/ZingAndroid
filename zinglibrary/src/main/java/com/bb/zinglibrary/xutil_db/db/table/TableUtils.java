...
import com.bb.zinglibrary.xutil_db.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.bb.zinglibrary.xutil_db.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.bb.zinglibrary.xutil_db.db.table.Id>();

    /* package */
    static synchronized com.bb.zinglibrary.xutil_db.db.table.Id getId(Class<?> entityType) {
        ...
        com.bb.zinglibrary.xutil_db.db.table.Id id = new com.bb.zinglibrary.xutil_db.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.bb.zinglibrary.xutil_db.db.table.Id id = getId(entityType);
